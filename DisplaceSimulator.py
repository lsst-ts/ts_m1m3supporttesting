...
class DisplacementSimulator(Simulator):
    ...
    def displacementResponse(
        ...
        if displace1 < -999.9999 or displace1 > 999.9999:
            raise Exception(
                "displace1 is outside the valid range of values [-999.9999, +999.9999]"
            )
        if displace2 < -999.9999 or displace2 > 999.9999:
            raise Exception(
                "displace2 is outside the valid range of values [-999.9999, +999.9999]"
            )
        if displace3 < -999.9999 or displace3 > 999.9999:
            raise Exception(
                "displace3 is outside the valid range of values [-999.9999, +999.9999]"
            )
        if displace4 < -999.9999 or displace4 > 999.9999:
            raise Exception(
                "displace4 is outside the valid range of values [-999.9999, +999.9999]"
            )
        if displace5 < -999.9999 or displace5 > 999.9999:
            raise Exception(
                "displace5 is outside the valid range of values [-999.9999, +999.9999]"
            )
        if displace6 < -999.9999 or displace6 > 999.9999:
            raise Exception(
                "displace6 is outside the valid range of values [-999.9999, +999.9999]"
            )
        if displace7 < -999.9999 or displace7 > 999.9999:
            raise Exception(
                "displace7 is outside the valid range of values [-999.9999, +999.9999]"
            )
        if displace8 < -999.9999 or displace8 > 999.9999:
            raise Exception(
                "displace8 is outside the valid range of values [-999.9999, +999.9999]"
            )

        displaceArray = [
            self.DISPLACEMENT_FORMAT.format(num=displace1),
        ...
        responseString = (
            self.RESPONSE_BEGIN + ",".join(displaceArray) + self.RESPONSE_END
        )
        responseLength = len(responseString)

        response = bytearray()
        self.dataCheck(
            responseString, "Displacement Response", response, responseLength
        )
...
def main():
    ...
    response = displaceSim.displacementResponse(
        -19.7297, 4.8019, 6.0861, 4.2432, 5.0091, 5.3213, 2.0120, 11.0113
    )
