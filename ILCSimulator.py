...
class ILCSimulator(Simulator):
    ...
    def forceAndStatusRequest(
        self, serverAddr, statusByte, ssiEncoderValue, loadCellForce
    ):
        response = bytearray()
    ...
    def readBoostValueDcaGains(
        self, serverAddr, axialBoostValveGain, lateralBoostValveGain
    ):
        response = bytearray()
    ...
    def dualPneumaticAxisForce(
        self, serverAddr, statusByte, axialLoadCellForce, lateralLoadCellForce
    ):
        response = bytearray()
    ...
    def dualPneumaticForceAndStatus(
        self, serverAddr, statusByte, axialLoadCellForce, lateralLoadCellForce
    ):
        response = bytearray()
    ...
    def readDacValues(
        ...
        dac1ValueAxialPush,
        dac2ValueAxialPush,
        dac3ValueLateralPush,
        dac4ValueLateralPush,
    ):
        response = bytearray()
    ...
    def readCalibrationData(
        ...
        self.dataCheck(
            backupSensorSensitivity1, "Backup Sensor Sensitivity1", response, 4
        )
        self.dataCheck(
            backupSensorSensitivity2, "Backup Sensor Sensitivity2", response, 4
        )
        self.dataCheck(
            backupSensorSensitivity3, "Backup Sensor Sensitivity3", response, 4
        )
        self.dataCheck(
            backupSensorSensitivity4, "Backup Sensor Sensitivity4", response, 4
        )
    ...
    def readDcaPressureValues(
        self,
        serverAddr,
        pressure1AxialPush,
        pressure2AxialPull,
        pressure3LateralPull,
        pressure4LateralPush,
    ):
        response = bytearray()
...
def main():
    ...
    response = ilcs.readCalibrationData(
        1,
        123.45,
        234.56,
        345.67,
    ...
    assert (
        bytes([11, 1, 122, 8, 0x3F, 0x99, 0x99, 0x9A, 0x40, 0x13, 0x33, 0x33])
        == response
    )
