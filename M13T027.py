    ...
    def Run(self, m1m3, sim, efd):
        ...
        for row in forceActuatorTable:
            ...
            if x != -1:
                ...
                InTolerance("FA%03d +X ForceActuatorData.XForce[%d]" % (id, x), Average(datas, lambda d: d.XForce[x]), forceActuatorXLimitTable[x][forceActuatorLimitMax], TEST_TOLERANCE)
                InTolerance("FA%03d +X ForceActuatorData.ZForce[%d]" % (id, z), Average(datas, lambda d: d.ZForce[z]), 0.0, TEST_TOLERANCE)
                ...
                # Check force actuator force
                datas = self.SampleForceActuators(m1m3)
                InTolerance("FA%03d -X ForceActuatorData.XForce[%d]" % (id, x), Average(datas, lambda d: d.XForce[x]), forceActuatorXLimitTable[x][forceActuatorLimitMin], TEST_TOLERANCE)
                InTolerance("FA%03d -X ForceActuatorData.ZForce[%d]" % (id, z), Average(datas, lambda d: d.ZForce[z]), 0.0, TEST_TOLERANCE)               
            ...
            datas = self.SampleForceActuators(m1m3)
            if x != -1:
                InTolerance("FA%03d +Z ForceActuatorData.XForce[%d]" % (id, x), Average(datas, lambda d: d.XForce[x]), 0.0, TEST_TOLERANCE)
            if y != -1:
