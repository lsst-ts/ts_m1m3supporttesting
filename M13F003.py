    ...
    def Run(self, m1m3, sim):
        ...
        for row in forceActuatorTable:
            ...
            if x != -1:
                ...
                InTolerance("AppliedCylinderForces.SecondaryCylinderForces[%d]" % s, data.SecondaryCylinderForces[s], secondaryCylinderForce * 1000, 0.1)
                InTolerance("AppliedCylinderForces.PrimaryCylinderForces[%d]" % z, data.PrimaryCylinderForces[z], primaryCylinderForce * 1000, 0.1)
                time.sleep(1)
