...
class M13TDPV:
    def Run(self, m1m3, sim, efd):
        ...
        file = open(path, "w+")
        file.write(
            "ActId,AxialCylinderSetpoint,LateralCylinderSetpoint,AxialCylinderForce,LateralCylinderForce\r\n"
        )
        ...
        for row in forceActuatorTable:
            ...
            s = (
                -1
            )  # S (Secondary Cylinder) index for data access, if -1 no S data available
            ...
            if orientation in ["+X"]:
                ...
                tests = [[0.0, 0.0, 6000.0], [0.0, 0.0, -6000.0]]
