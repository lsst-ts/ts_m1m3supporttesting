...
class M13RandomAOS8Hour:
    def Run(self, m1m3, sim, efd):
        ...
        Equal(
            "SAL m1m3_logevent_DetailedState.DetailedState",
            data.DetailedState,
        ...
        InTolerance(
            "SAL m1m3_HardpointActuatorData.XPosition",
            data.XPosition,
            REFERENCE_X_POSITION,
            POSITION_TOLERANCE,
        )
        InTolerance(
            "SAL m1m3_HardpointActuatorData.YPosition",
            data.YPosition,
            REFERENCE_Y_POSITION,
            POSITION_TOLERANCE,
        )
        InTolerance(
            "SAL m1m3_HardpointActuatorData.ZPosition",
            data.ZPosition,
            REFERENCE_Z_POSITION,
            POSITION_TOLERANCE,
        )
        InTolerance(
            "SAL m1m3_HardpointActuatorData.XRotation",
            data.XRotation,
            REFERENCE_X_ROTATION,
            ROTATION_TOLERANCE,
        )
        InTolerance(
            "SAL m1m3_HardpointActuatorData.YRotation",
            data.YRotation,
            REFERENCE_Y_ROTATION,
            ROTATION_TOLERANCE,
        )
        InTolerance(
            "SAL m1m3_HardpointActuatorData.ZRotation",
            data.ZRotation,
            REFERENCE_Z_ROTATION,
            ROTATION_TOLERANCE,
        )

        result, data = m1m3.GetSampleIMSData()
        InTolerance(
            "SAL m1m3_IMSData.XPosition",
            data.XPosition,
            REFERENCE_X_POSITION,
            POSITION_TOLERANCE,
        )
        InTolerance(
            "SAL m1m3_IMSData.YPosition",
            data.YPosition,
            REFERENCE_Y_POSITION,
            POSITION_TOLERANCE,
        )
        InTolerance(
            "SAL m1m3_IMSData.ZPosition",
            data.ZPosition,
            REFERENCE_Z_POSITION,
            POSITION_TOLERANCE,
        )
        InTolerance(
            "SAL m1m3_IMSData.XRotation",
            data.XRotation,
            REFERENCE_X_ROTATION,
            ROTATION_TOLERANCE,
        )
        InTolerance(
            "SAL m1m3_IMSData.YRotation",
            data.YRotation,
            REFERENCE_Y_ROTATION,
            ROTATION_TOLERANCE,
        )
        InTolerance(
            "SAL m1m3_IMSData.ZRotation",
            data.ZRotation,
            REFERENCE_Z_ROTATION,
            ROTATION_TOLERANCE,
        )
        ...
        while True:
            ...
            faResults.append(
                [
                    counter,
                    faData.PrimaryCylinderForce,
                    faData.SecondaryCylinderForce,
                    faData.XForce,
                    faData.YForce,
                    faData.ZForce,
                    faData.Fx,
        ...
        f = open(path, "w+")
        f.write(
            "LoopCounter,HP-XPosition,HP-YPosition,HP-ZPosition,HP-XRotation,HP-YRotation,HP-ZRotation,IMS-XPosition,IMS-YPosition,IMS-ZPosition,IMS-XRotation,IMS-YRotation,IMS-ZRotation\r\n"
        )
        for r in displacementResults:
            f.write(
                "%s,%0.9f,%0.9f,%0.9f,%0.9f,%0.9f,%0.9f,%0.9f,%0.9f,%0.9f,%0.9f,%0.9f,%0.9f\r\n"
                % (
                    r[0],
                    r[1],
                    r[2],
