def CalculateVelocityForces(angularVelocityX, angularVelocityY, angularVelocityZ):
    ...
    for i in range(len(xTable)):
        xForce = (wx * xTable[i][0] + wy * yTable[i][0] + wz * zTable[i][0] + wxwz * xzTable[i][0] + wywz * yzTable[i][0]) / 1000.0
        yForce = (wx * xTable[i][1] + wy * yTable[i][1] + wz * zTable[i][1] + wxwz * xzTable[i][1] + wywz * yzTable[i][1]) / 1000.0
        zForce = (wx * xTable[i][2] + wy * yTable[i][2] + wz * zTable[i][2] + wxwz * xzTable[i][2] + wywz * yzTable[i][2]) / 1000.0
