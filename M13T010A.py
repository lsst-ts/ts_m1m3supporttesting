...
# NOTE: This is a derivative of M13T-010
# Steps:
# - Issue start command
...
#        time.sleep(5.0)
        ...
        Log("result from GetSampleHardpointActuatorData is %d" % result)
        ...
        Log("result from GetSampleIMSData is %d" %  result)
        ...
        path = GetFilePath("M13T010-Positions.csv")
