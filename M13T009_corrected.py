...
class M13T009:
    ...
    def Run(self, m1m3, sim, efd):
        ...
        for row in testTable:
            ...
            InTolerance("SAL %s m1m3_HardpointActuatorData.XForce" % row[0], data.Fx, LOAD_PATH_FORCE, LOAD_PATH_TOLERANCE)
            InTolerance("SAL %s m1m3_HardpointActuatorData.YForce" % row[0], data.Fy, LOAD_PATH_FORCE, LOAD_PATH_TOLERANCE)
            InTolerance("SAL %s m1m3_HardpointActuatorData.ZForce" % row[0], data.Fz, LOAD_PATH_FORCE, LOAD_PATH_TOLERANCE)
            InTolerance("SAL %s m1m3_HardpointActuatorData.XMoment" % row[0], data.Mx, LOAD_PATH_FORCE, LOAD_PATH_TOLERANCE)
            InTolerance("SAL %s m1m3_HardpointActuatorData.YMoment" % row[0], data.My, LOAD_PATH_FORCE, LOAD_PATH_TOLERANCE)
            InTolerance("SAL %s m1m3_HardpointActuatorData.ZMoment" % row[0], data.Mz, LOAD_PATH_FORCE, LOAD_PATH_TOLERANCE)
